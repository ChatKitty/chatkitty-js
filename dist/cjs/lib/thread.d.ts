...
export declare type CreateThreadResult = CreatedThreadResult | ChatKittyFailedResult;
...
export declare type GetThreadsResult = GetThreadsSucceededResult | ChatKittyFailedResult;
...
export declare type GetThreadChannelResult = GetThreadChannelSucceededResult | ChatKittyFailedResult;
...
export declare type GetThreadMessageResult = GetThreadMessageSucceededResult | ChatKittyFailedResult;
...
export declare type ReadThreadResult = ReadThreadSucceededResult | ChatKittyFailedResult;
