...
export declare type GetChannelsResult = GetChannelsSucceededResult | ChatKittyFailedResult;
...
export declare type GetChannelResult = GetChannelSucceededResult | ChatKittyFailedResult;
export declare class GetChannelSucceededResult extends ChatKittySucceededResult {
    channel: Channel;
    constructor(channel: Channel);
}
export declare type GetChannelUnreadResult = GetChannelUnreadSucceededResult | ChatKittyFailedResult;
